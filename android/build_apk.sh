...
UNSIGNED_APK="$BUILD_DIR/task-manager-luxe-unsigned.apk"
ALIGNED_APK="$BUILD_DIR/task-manager-luxe-aligned.apk"
FINAL_APK="$BUILD_DIR/task-manager-luxe.apk"
DOWNLOADS_DIR="$ROOT_DIR/downloads"
WEB_APK="$DOWNLOADS_DIR/task-manager-luxe.apk"
